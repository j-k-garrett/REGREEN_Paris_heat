...
ggsave(file.path(figure_d, "S5_Paris_region_distance_to_others.png"), dpi = 300, width = 7, height = 2.5, bg = "white")
...
for (i in 1:NROW(Parks_master_150m_dist)){
  ...
  for (j in 1:44){
    ...
    if (j == 1 & length(expanse(Buff_min)) == 0){
...
## Save results
write.csv(step_1_results, paste0("step_1_resuts_575_150m_",Sys.Date(),".csv"))
