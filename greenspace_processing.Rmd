...
## Make sure all libraries are installed and change data_d to own data directory
library(terra)
library(dplyr)
library(sf)
library(nngeo)
...
setwd(file.path(data_d, "green-spaces-woods-open-or-planned-to-open-to-the-public"))
...
water_bodies<-st_read(paste0(data_d,"\\Analysis_2024\\water_paris_polygon_osm.shp")) %>%
  st_make_valid()
...
writeVector(greenspaces_central,paste0("greenspaces_central_",Sys.Date(),".shp"))
```
