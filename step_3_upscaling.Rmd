...
setwd(figure_d)
ggsave("temps_boundaries_three_days.png", dpi = 300, width = 7, height = 4, bg = "white")
...
setwd(figure_d)
ggsave("RR_mortality_by_temp.png", dpi = 300, height = 3, width = 3.5, bg = "white")
rm(p)
...
# Save to shapefile
writeVector(Parks_grtr_1000, paste0("Parks_grtr_1000_with_values_",Sys.Date(),".shp"))
...
write.csv(descrptives, "lives_saved_val_descriptives2.csv")
descrptives<-descrptives %>%
  as_flextable() %>%
...
p
setwd(figure_d)
ggsave("hist_value.png", width = 7, height = 3.5, units ="in", bg = "white")
...
p
setwd(figure_d)
ggsave("map_values.png", width = 7, height = 3.5, units ="in", dpi = 300, bg = "white")
```